...
import static com.example.pert8_sqllitedatabase.DBmain.TABLENAME;
...
import com.example.pert8_sqllitedatabase.databinding.ActivityDisplayDataBinding;
...
public class DisplayData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(DisplayData.this, MainActivity5.class);
                startActivity(a);
            }
        });
    }
    ...
    private void displayData() {
        ...
        while (cursor.moveToNext()) {
            ...
            models.add(new Model(id, avatar, judul_lagu, artis, tahun));
        }
        cursor.close();
